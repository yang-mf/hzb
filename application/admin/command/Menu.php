...
class Menu extends Command
{
    ...
    /*
     *  2020/11/24 11:20:54 [error] 19924#14560: 198 connect()
        failed (10061: No connection could be made because the target machine actively refused it)
         while connecting to upstream, client: 127.0.0.1,
        server: www.test.com, request: "GET /NVftLdwgMn.php/general/config?ref=addtabs HTTP/1.1",
