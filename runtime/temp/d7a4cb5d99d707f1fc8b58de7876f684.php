<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpstudy_pro\WWW\fw366.cn\public/../application/index\view\test\test.html";i:1608015920;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    new Vue({
        ...
        data: function() {
            return {
                ...
                all_school_num:[],                  //后台传值（分数位次对应的院校代码）
        ...
        methods: {
                ...
                }   else
                {
                    $.post('/index/test/get_select_info', {
                        ...
                        if(response['code']==1){
                            ...
                            console.log((_this.info));
                            _this.load_school_name();
                            _this.load_profession_name();return
                        }
                    });
                }
                return;
            ...
            load_profession_name(state=null, cb) {
                ...
                var all_school_num = this.all_school_num ? this.all_school_num : '';            //后台传值（院校代码）
