<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpstudy_pro\WWW\fw366.cn\public/../application/index\view\test\test.html";i:1608189454;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            onSubmit() {
                ...
                if(this.sta_profession.length == 0 && this.sta_school.length == 0
                    ...
                    if(this.sta_school['school_num']) {
                        sta_school_num=this.sta_school['school_num'];
                    }
